...
export const remainingDistributionTooltipText = 'This indicates the number of tokens still available for distribution. Once all tokens are claimed, this distribution will close.'
